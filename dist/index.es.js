...
var Header = function Header(_ref) {
  ...
  return React.createElement(
    'div',
    { style: styles.main },
    image && React.createElement('div', { style: _extends({}, styles.img, { backgroundImage: 'url(' + image + ')' }) }),
    React.createElement(
      'span',
      { style: styles.text },
      React.createElement(
...
function seeMore(props) {
  return props.showContent ? React.createElement(
    'div',
...
var Story = function (_React$Component) {
  ...
  createClass(Story, [{
    ...
    value: function getStoryContent() {
      ...
      return type === 'video' ? React.createElement('video', { ref: function ref(r) {
          _this3.vid = r;
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Header, { authorName: authorName, timeago: timeago, image: profileImage })
        ),
        React.createElement(
          'div',
        ...
        !this.state.loaded && React.createElement(
          ...
          this.props.loader || React.createElement('div', { className: style.spinner })
        ),
        this.props.story.seeMore && React.createElement(
          'div',
          { style: { position: 'absolute', margin: 'auto', bottom: 0, zIndex: 9999, width: '100%' } },
          React.createElement(seeMore, { action: this.props.action, toggleMore: this.toggleMore, showContent: this.state.showMore, seeMoreContent: this.props.story.seeMore })
        )
      );
    }
  }]);
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('div', { style: { width: '50%', zIndex: 999 }, onTouchStart: this.debouncePause, onTouchEnd: function onTouchEnd(e) {
